...
classdef motor < handle 
    ...
    properties (Constant, Hidden)
     ...
     %  DCSERVODLL='Thorlabs.MotionControl.KCube.DCServoCLI.dll';  
      DCSERVODLL='Thorlabs.MotionControl.KCube.BrushlessMotorCLI.dll'; 
       DCSERVOCLASSNAME='Thorlabs.MotionControl.KCube.BrushlessMotorCLI.KCubeBrushlessMotor';  
        ...
        function connect(h,serialNo)  % Connect device
            ...
            if ~h.isconnected
                switch(serialNo(1:2))
                 ...
                 %   case '28' %%% CORRESPONDS TO MY MOTOR?
